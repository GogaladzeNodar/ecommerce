...
def test_inventory_db_product_dbfixture(
   ...
   updated_at,
    ...
    expected_created_at = datetime.strptime(created_at, "%Y-%m-%d %H:%M:%S")
    expected_updated_at = datetime.strptime(updated_at, "%Y-%m-%d %H:%M:%S")
...
def test_inventory_db_product_inventory_insert_data(
    ...
    new_product = product_inventory_factory(
        sku="123456789",
        upc="123456789",
...
# not add same names inside ProductType table
...
# not add same names inside Brand table
...
#######################################################
#
#  Tests for ProductAttribute table 
#
...
def test_inventory_db_product_attribute_insert_date(
...
def test_inventory_db_product_attribute_value_date(
